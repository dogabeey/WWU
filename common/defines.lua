...
NCountry = {
	...
	CONCENTRATE_DEVELOPMENT_DEVELOPMENT_DECREASE = 0.4,
...
NAI = {
	...
	ACCEPTABLE_BALANCE_DEFAULT = 1.01, --AI wants this advantage to enter battles typically. (There are some exceptions, e.g. offensives.)
	...
	ADVISOR_BUDGET_FRACTION = 0.33, -- AI will spend a maximum of this fraction of monthly income on advisor maintenance
...
NGovernment = {
	...
	CONCENTRATE_DEVELOPMENT_CAPITAL_PROPORTION = 0.2,
