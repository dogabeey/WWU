...
NGame = {
	START_DATE = "546.11.11",
	END_DATE = "1399.1.2",
	MAX_RANDOM_NEW_WORLD = "546.1.1",

	GREAT_POWER_FRENZY_START = "1300.1.1",	-- Latest date for the start of the Great Power Frenzy (struggle).
...
NGovernment = {
	...
	LEGACY_NATIVES_REFORM_REPUBLIC_SPONSOR = "peasants_republic_legacy",
	LEGACY_NATIVES_REFORM_MONARCHY_SPONSOR = "despotic_monarchy",
	LEGACY_NATIVES_REFORM_THEOCRACY_SPONSOR = "holy_republic_government",
