...
NDefines.NCountry.CULTURAL_UNION_MIN_RANK = 9				-- Minimum rank to get cultural union effect with Common Sense.
...
NDefines.NCountry.ADDITIONAL_MIN_DEVELOPMENT_FOR_GOV_RANK_X = 100	-- ADDITIONAL development needed to upgrade to government rank above 3
