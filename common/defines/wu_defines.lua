...
NDefines.NDiplomacy.UNCONDITIONAL_SURRENDER_MONTHS = 12				-- Months before unconditional surrender starts having an effect on Call for Peace. Set to negative values to disable feature.
...
NDefines.NDiplomacy.MAX_FREE_CITIES = 100
...
NDefines.NDiplomacy.MAX_NUM_OF_ELECTORS = 4						-- Maximum number of electors in the interface
...
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_2 = 500		-- Need at least this much development to upgrade to government rank 3
...
NDefines.NCountry.LEGITIMACY_DYNASTY_CHANGE = 50					-- Legitimacy a new dynasty starts out with
...
NDefines.NCountry.PS_ATTACK_NATIVES = 50
...
NDefines.NCountry.MAX_CROWN_COLONIES = 1							-- How many province a country can hold in a colonial region before creating a colonial nation
...
NDefines.NCountry.ESTATE_CROWNLAND_INFLUENCE = 75.0			-- Crownland has n% influence this is modified by absolutism.
...
NDefines.NCountry.HRE_INCIDENT_MEMBER_SUPPORT_IA = 0.25	-- How much worth an elector support is in an incident
...
NDefines.NEconomy.GOLD_MINE_SIZE_PRIMITIVES = 15				-- Gold income for very slow techgroups
...
NDefines.NEconomy.MISSIONARY_MAINTENANCE_AUTONOMY_BASE = 1
...
NDefines.NGovernment.LEADER_AS_MONARCH_TRADITION = 30 -- How much tradition leaders will get when generated for
