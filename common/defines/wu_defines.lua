...
NDefines.NCountry.CULTURAL_UNION_MIN_DEV = 500				-- Minimum development to get cultural union effect without Common Sense or if CULTURAL_UNION_MIN_RANK is set to negative value.
