...
NDefines.NEconomy.MISSIONARY_MAINTENANCE_FACTOR = 0.5				-- _EDEF_MISSIONARY_MAINTENANCE_FACTOR_
...
NDefines.NEconomy.MISSIONARY_MAINTENANCE_DEVELOPMENT_FACTOR = 1.0
